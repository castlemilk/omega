...
ON='{"crisis_skew_enabled": true, "crisis_skew_regime_gate_enabled": true, "crisis_skew_drawdown_threshold": 0.12, "ic_seed_weighting": true, "regime_conditional_ic_weighting": true, "ic_drawdown_gate_enabled": true, "ic_drawdown_threshold": 0.12}'
