// VECTORA TERMINAL — full eval dashboard ported from eval_dashboard.jsx
...
function SignalPanel() {
  return (
    <Panel title="SIGNAL QUALITY — VECTORA FACTORS">
...
export default function VectoraDashboard() {
  return (
    <VectoraPage>
      ...
      >
        Ω VECTORA TERMINAL v0.1 │ OMEGA SYSTEM │ {labels[0]} → {labels[labels.length - 1]} │ 504
