// VICTORIA BACKTEST — equity curve, Sharpe + CIs, drawdown, crash replay, ablation
...
import { fetchBacktestResults, fetchEquityCurve, fetchRiskMetrics } from "../api/victoria";

export default function VictoriaBacktest() {
  ...
  return (
    <VictoriaPage>
      ...
      <div style={{ padding: 3, display: "flex", flexDirection: "column", gap: 3 }}>
        ...
        <Panel title="PERFORMANCE — VICTORIA vs BTC BUY&HOLD" style={{ minHeight: 300 }}>
