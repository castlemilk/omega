/**
 * Victoria API client — wraps Connect-ES calls to VictoriaService.
...
export async function fetchPortfolio(): Promise<PortfolioData> {
  const result = await callApi(() => victoriaClient.getPortfolio({}));
...
export async function fetchPositions(): Promise<{ positions: Position[]; fromMock: boolean }> {
  const result = await callApi(() => victoriaClient.getPositions({}));
...
export async function fetchPnL(): Promise<PnLData> {
  const result = await callApi(() => victoriaClient.getPnL({}));
...
export async function fetchSignals(): Promise<SignalsData> {
  const result = await callApi(() => victoriaClient.getSignals({}));
...
export async function fetchSignalHistory(
  ...
  const result = await callApi(() => victoriaClient.getSignalHistory({ signalName, limit }));
...
export async function fetchTrades(
  ...
  const result = await callApi(() => victoriaClient.getTrades({ symFilter, sideFilter, limit }));
...
export async function fetchBacktestResults(): Promise<{
  ...
  const result = await callApi(() => victoriaClient.getBacktestResults({}));
...
export async function fetchEquityCurve(
  ...
  const result = await callApi(() => victoriaClient.getEquityCurve({ limit }));
...
export async function fetchRiskMetrics(): Promise<RiskMetricsData> {
  const result = await callApi(() => victoriaClient.getRiskMetrics({}));
